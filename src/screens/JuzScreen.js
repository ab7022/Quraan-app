      ...
      <View style={tw`bg-white px-6 py-4 mb-2`}>
        <View style={tw`flex-row items-center justify-between`}>
          <View style={tw`flex-1`}>
            <Text style={tw`text-2xl font-bold text-gray-900`}>Juz Collection</Text>
          ...
          <View style={tw`bg-green-100 px-4 py-3 rounded-xl`}>
            ...
            <Text style={tw`text-green-600 text-xs font-medium`}>Total Juz</Text>
          </View>
        </View>
      </View>
                  ...
                  <View style={tw`flex-row items-center justify-between`}>
                    ...
                    <View style={tw`flex-1 mr-4`}>
                      <View style={tw`flex-row items-center mb-3`}>
                        <View style={tw`w-12 h-12 bg-green-500 rounded-xl items-center justify-center mr-4`}>
                      ...
                      <View style={tw`flex-row items-center flex-wrap`}>
                        <View style={tw`bg-blue-100 rounded-lg px-3 py-1 mr-2 mb-1`}>
                        ...
                        <View style={tw`bg-green-100 rounded-lg px-3 py-1 mb-1`}>
