...
import { View, Text, ScrollView, TouchableOpacity, Linking, Alert, ImageBackground, Dimensions } from 'react-native';
...
export default function LearnQuranScreen({ navigation }) {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      image: 'https://images.unsplash.com/photo-1494790108755-2616c96c48e7?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-gray-50`}>
      ...
      <BlurView intensity={95} tint="light" style={tw`absolute top-0 left-0 right-0 z-50`}>
        <SafeAreaView>
          <View style={tw`px-6 py-4 flex-row items-center`}>
            ...
            <Text style={tw`text-xl font-bold text-gray-900 flex-1`}>Learn Quran - For Everyone</Text>
      ...
      >
        ...
        <ImageBackground
          source={{ uri: 'https://images.unsplash.com/photo-1542816417-0983c9c9ad53?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80' }}
          style={tw`mx-6 mt-6 rounded-3xl overflow-hidden`}
          imageStyle={tw`opacity-30`}
        >
          <LinearGradient
            colors={['rgba(16, 185, 129, 0.9)', 'rgba(5, 150, 105, 0.95)', 'rgba(4, 120, 87, 1)']}
            style={tw`p-8`}
          >
            <Animatable.View animation="fadeInUp" delay={200}>
              <View style={tw`items-center mb-6`}>
                ...
                >
                  <MaterialCommunityIcons name="book-open-variant" size={48} color="white" />
                </Animatable.View>
                <Text style={tw`text-3xl font-bold text-white text-center mb-3`}>
                  Transform Your
                  <Text style={tw`text-yellow-300`}> Quran Journey</Text>
                </Text>
                <Text style={tw`text-white/90 text-center text-lg leading-7 max-w-sm`}>
                  Master the art of beautiful recitation with world-class teachers and personalized guidance
                </Text>
              </View>
              ...
              <View style={tw`flex-row justify-between mt-6`}>
                {[
                  ...
                  >
                    <Text style={tw`text-2xl font-bold text-white`}>{stat.number}</Text>
            ...
            <View style={tw`mx-6 mt-6 rounded-3xl overflow-hidden shadow-2xl`}>
              ...
              >
                <View style={tw`flex-row items-center`}>
                  ...
                  >
                    <MaterialCommunityIcons name="gift" size={32} color="white" />
                  </Animatable.View>
                  <View style={tw`flex-1`}>
                    <View style={tw`flex-row items-center mb-2`}>
                      ...
                      <View style={tw`bg-yellow-400 px-3 py-1 rounded-full`}>
                        <Text style={tw`text-xs font-bold text-gray-900`}>7 DAYS</Text>
                      </View>
                    </View>
        ...
        <View style={tw`mx-6 mt-8`}>
          <Text style={tw`text-2xl font-bold text-gray-900 mb-6`}>What You'll Master</Text>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                >
                  ...
                  <Text style={tw`text-base font-bold text-gray-900 mb-2 leading-tight`} numberOfLines={2}>
                    {feature.title}
                  </Text>
                  <Text style={tw`text-xs text-gray-600 leading-4`} numberOfLines={3}>
                    {feature.description}
                  </Text>
                </TouchableOpacity>
              </Animatable.View>
        ...
        <View style={tw`mx-6 mt-12`}>
          <Text style={tw`text-2xl font-bold text-gray-900 mb-6`}>Why We're Different</Text>
          <View style={tw`bg-white rounded-3xl p-6 border border-gray-100`}>
            {[
              { icon: 'account-star', text: 'World-Class Expert Teachers', color: '#10B981', desc: 'Learn from certified Qaris with years of experience' },
              { icon: 'clock-fast', text: 'Flexible Learning Schedule', color: '#3B82F6', desc: 'Choose times that work perfectly for you' },
              { icon: 'video-account', text: 'Personal One-on-One Sessions', color: '#8B5CF6', desc: 'Get individual attention and customized feedback' },
              { icon: 'trophy-award', text: 'Achievement Recognition', color: '#EF4444', desc: 'Earn certificates and track your progress' },
              { icon: 'heart-pulse', text: 'Spiritual Growth Focus', color: '#F59E0B', desc: 'Connect deeply with the Quran and your faith' }
            ].map((item, index) => (
              <Animatable.View
                key={item.text}
              ...
              >
                <View style={tw`flex-row items-start mb-6 ${index < 4 ? 'border-b border-gray-100 pb-6' : ''}`}>
                  <LinearGradient
                  ...
                  <View style={tw`flex-1`}>
                    <Text style={tw`text-base font-bold text-gray-900 mb-1`}>{item.text}</Text>
                    <Text style={tw`text-sm text-gray-600 leading-5`}>{item.desc}</Text>
                  </View>
                  <Animatable.View
                    animation="pulse"
                    iterationCount="infinite"
        ...
        <View style={tw`mx-6 mt-12`}>
          <View style={tw`text-center mb-8`}>
            <Text style={tw`text-3xl font-bold text-gray-900 mb-3`}>Ready to Transform?</Text>
          ...
          <View style={tw`bg-gradient-to-br rounded-3xl overflow-hidden mb-6`}>
            ...
            >
              <View style={tw`items-center`}>
                ...
                <Text style={tw`text-white/90 text-center mb-6 text-base leading-6`}>
                ...
                >
                  <View style={tw`flex-row items-center`}>
                    <FontAwesome5 name="whatsapp" size={24} color="#25D366" style={tw`mr-3`} />
                ...
                <Text style={tw`text-white/90 text-sm text-center`}>
                  Or call us at: <Text style={tw`text-white font-bold`}>+91 {phoneNumber}</Text>
                </Text>
              </View>
            </LinearGradient>
          </View>
          ...
          <View style={tw`flex-row gap-3 mb-20`}>
            {[
              { icon: 'clock-time-four', text: '7-Day Free Trial', color: '#3B82F6' },
              { icon: 'shield-check', text: '100% Secure', color: '#10B981' },
              { icon: 'account-heart', text: '1000+ Students', color: '#EF4444' }
            ].map((item, index) => (
              <Animatable.View
                key={item.text}
                animation="fadeInUp"
              ...
              >
                ...
                <Text style={tw`text-xs font-semibold text-gray-700 text-center`}>
                  {item.text}
                </Text>
              </Animatable.View>
            ))}
