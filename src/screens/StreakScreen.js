      ...
      <ScrollView style={tw`flex-1`} showsVerticalScrollIndicator={false}>
        <View style={tw`px-7 pt-6`}>
          ...
          <View style={tw`items-center mb-8`}>
            <Animated.View
              style={[tw`mb-8`, { transform: [{ scale: pulse }] }]}
            >
              <Ionicons name="flame" size={80} color="#4F8A10" />
            </Animated.View>
            <Text
              style={tw`text-3xl font-bold text-green-900 dark:text-green-200 mb-2 text-center`}
            >
              {streak} Day{streak === 1 ? '' : 's'} 🔥
            </Text>
            <Text
              style={tw`text-base text-gray-600 dark:text-gray-200 mb-6 text-center`}
            >
              Keep up your daily Qur'an reading to maintain your streak and
              build a life-changing habit!
            </Text>

            <View
              style={tw`bg-green-50 dark:bg-green-800 w-full rounded-2xl p-6 shadow mb-6`}
            >
              <Text
                style={tw`text-lg font-semibold text-green-800 dark:text-green-100 mb-2`}
              >
                How does the streak work?
              </Text>
              <Text style={tw`text-base text-gray-700 dark:text-gray-200`}>
                Each day you read a Surah or Juz, your streak increases. Missing
                a day resets the streak to 1. Your progress is saved on your
                device.
              </Text>
            </View>
          </View>
