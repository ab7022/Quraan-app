...
export default function AnalyticsDashboard() {
  ...
  const StatCard = ({ icon, title, value, subtitle, color = '#8B5CF6' }) => (
    <View
      style={tw`bg-white rounded-xl p-4 shadow-sm border border-gray-100 mb-4`}
    >
          ...
          <View style={tw`flex-row items-start`}>
            ...
            <View style={tw`flex-1`}>
              ...
              <Text style={tw`text-blue-700 text-sm leading-5`}>
                All analytics data is collected anonymously and used only to
                improve your reading experience. No personal information is
                shared.
              </Text>
            </View>
          </View>
        ...
        <View style={tw`mt-6`}>
          ...
          >
            <Ionicons
              ...
              style={tw`mr-2`}
            />
            <Text style={tw`text-gray-700 font-medium`}>Disable Analytics</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ScrollView>
