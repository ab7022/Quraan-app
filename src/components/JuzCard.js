  ...
  return (
    ...
    >
      <View style={tw`flex-row items-center`}>
        ...
        <View>
          <Text style={tw`text-lg font-semibold text-black dark:text-white`}>Juz {juz.juz_number}</Text>
          <Text style={tw`text-sm text-gray-500 dark:text-gray-400`}>Juz {juz.juz_number}</Text>
        </View>
      </View>
